...
- Agile V: C2 active; Gate 1 `GATE-0006` + CR-0003 `GATE-0007`; tip `b9c5e4d` / HEAD `1eb9965` (people IA + cross-domain densify); Wave 5/EvalGate FAIL still blocks C2 Gate 2 (nonlocal evidence).
