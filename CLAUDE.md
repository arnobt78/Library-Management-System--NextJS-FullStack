...
- KPI lendable + overview inactive + featured densify tip `d8845bc` (2026-08-09): active-only copy KPIs; Inactive mid panel; books-nav unfiltered; Top Rated rating↓/A-Z; `featuredRoot` replace/evict; inactive clears featured.
