...
- Agile V: C2 active; Gate 1 `GATE-0006` + CR-0003 `GATE-0007`; tip `b0b76bc` / HEAD `b7ebef4`; CTA silent Zod shipped; Wave 5/EvalGate FAIL blocks Gate 2.
...
- Book CRUD UX closeout (2026-08-15): Overview year/lang top-5 + distinct `+N more` + densify year DESC=SSR; BookForm confirm stays until detail push; `/all-books` create densify pagination-/sort-aware; Insights Popular Genres (by borrows) + chart empty states + TicketSectionHeader chrome.
