...
- Agile V: C2 active; Gate 1 `GATE-0006` + CR-0003 `GATE-0007`; tip `3dd4594` / HEAD `e6c4210`; Wave 5/EvalGate FAIL still blocks C2 Gate 2 (nonlocal evidence).
...
- Admin filter UX Prove (2026-08-07): type/lint/**151** tests + Next 16.2.12 build PASS; tip `3dd4594` / HEAD `e6c4210`.
