...
- Agile V: C2 active; Gate 1 `GATE-0006` + CR-0003 `GATE-0007`; tip `073afae` / HEAD `b672671`; densify closeout + Sentry auth filter + root 404 contrast shipped; ImageKit upload-limit deferred; EvalGate FAIL blocks Gate 2.
