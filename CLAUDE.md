...
- Agile V: C2 active; Gate 1 `GATE-0006` + CR-0003 `GATE-0007`; User 360 densify shipping (tip-bind after commit); Wave 5/EvalGate FAIL still blocks C2 Gate 2 (nonlocal evidence).
