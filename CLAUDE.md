...
- Agile V: C2 active; Gate 1 `GATE-0006` + CR-0003 `GATE-0007`; tip `90363ef`; Wave 5/EvalGate FAIL still blocks C2 Gate 2 (nonlocal evidence).
...
- Borrow Queue Status & Actor (2026-08-13): Borrower + `TicketDateMeta` Requested; drop Status col; `BorrowQueueStatusActorCell` (Pending/Cancelled/Borrowed+Approved+Due/Returned+Self-returned).
