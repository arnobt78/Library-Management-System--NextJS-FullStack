...
- Agile V: C2 active; Gate 1 `GATE-0006` + CR-0003 `GATE-0007`; tip `44a08ba` / HEAD `fd43f22`; densify closeout + Sentry auth filter + root 404 dark shell shipped; ImageKit upload-limit deferred; EvalGate FAIL blocks Gate 2.
