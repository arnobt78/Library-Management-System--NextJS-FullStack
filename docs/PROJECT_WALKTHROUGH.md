...
- REJECTED students re-apply → PENDING (`requestRegistrationReview`); welcome email on signup (pending + make-admin mention); Approve/Reject/Return spinners + optimistic pending remove.
